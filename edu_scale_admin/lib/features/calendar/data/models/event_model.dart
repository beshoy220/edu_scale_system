class EventModel {
  ...
  @override
  String toString() {
    return 'EventModel(id: $id, schoolId: $schoolId, title: $title, description: $description, dayDate: $dayDate, startTime: $startTime, endTime: $endTime, createdAt: $createdAt, targets: $targets)';
  }
}

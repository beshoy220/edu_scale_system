...
import '../model/class_for_parents_model.dart';

class GetClassesForParentsRemoteDataSource {
  Future<List<ClassForParentsModel>> get() async {
    // 1. Get school_id
    ...
    return (res as List<dynamic>)
        .map((e) => ClassForParentsModel.fromJson(e as Map<String, dynamic>))
        .toList();
  }
}

...
class ParentAssignmentInfoBottomSheet extends StatelessWidget {
  const ParentAssignmentInfoBottomSheet({super.key});
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          const TextSpan(
                            text:
                                'Assignments that have passed their due date are displayed here.\n\nEach assignment is marked as ',
                          ),
                          TextSpan(
                            text: 'Done',
                            style: TextStyle(
                          ...
                          const TextSpan(
                            text:
                                ' depending on whether your child completed it before the deadline.\n\nIf the assignment has been done, your child\'s score will also be shown.',
                          ),
                        ],
                      ),
                    ),

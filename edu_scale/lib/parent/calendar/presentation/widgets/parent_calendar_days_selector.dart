...
class ParentCalendarDaysSelector extends StatefulWidget {
  final Function(DateTime selectedDate) onDateSelected;
  final Function(DateTime focusedDay) onPageChanged;
  final DateTime? initialDate;
  final List<DateTime> eventDates;

  const ParentCalendarDaysSelector({
    super.key,
  ...
  @override
  State<ParentCalendarDaysSelector> createState() =>
      _ParentCalendarDaysSelectorState();
}

class _ParentCalendarDaysSelectorState
    extends State<ParentCalendarDaysSelector> {

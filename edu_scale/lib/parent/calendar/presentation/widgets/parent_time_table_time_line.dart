...
class ParentTimeTableTimeLine extends StatelessWidget {
  final List<ParentTimetableSessionModel> sessions;

  const ParentTimeTableTimeLine({super.key, required this.sessions});

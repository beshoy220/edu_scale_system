...
import 'package:edu_scale/parent/calendar/data/data_sources/get_parent_time_table_remote_data_source.dart';

class ParentTimeTableProvider extends ChangeNotifier {
  final GetParentTimeTableRemoteDataSource _dataSource =
      GetParentTimeTableRemoteDataSource();

  bool isLoading = false;
  String? errorMessage;
  List<ParentTimetableSessionModel> sessions = [];

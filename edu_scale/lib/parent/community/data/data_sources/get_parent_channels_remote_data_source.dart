...
class GetParentChannelsRemoteDataSource {
  Future<List<ParentChannelModel>> getParentChannels() async {
    ...
    // 3] model response
    return response.map((e) => ParentChannelModel.fromJson(e)).toList();
  }
}

...
class GetParentChannelMessagesRemoteDataSource {
  static Future<List<ParentChannelMessageModel>> getLast100Messages({
    ...
    // 2] convert the response to a list of ParentChannelMessageModel objects
    return (response as List)
        .map(
          (e) => ParentChannelMessageModel.fromJson(e as Map<String, dynamic>),
        )
        .toList();
  }
}

...
class ParentChannelPage extends StatefulWidget {
  const ParentChannelPage({super.key, required this.channel});

  final ParentChannelModel channel;

  @override
  State<ParentChannelPage> createState() => _ParentChannelPageState();
}

class _ParentChannelPageState extends State<ParentChannelPage> {
  @override
  void initState() {
    super.initState();

    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ParentChannelMessagesProvider>().loadMessages(
  ...
  Widget build(BuildContext context) {
    final provider = context.watch<ParentChannelMessagesProvider>();
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  SizedBox(width: 12),
                  Expanded(child: Text('Parents cannot send messages yet.')),
                ],
              ),
            ),
          ],

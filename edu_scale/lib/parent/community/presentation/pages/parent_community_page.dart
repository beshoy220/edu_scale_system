...
import 'package:edu_scale/parent/community/presentation/pages/parent_channel_page.dart';
import 'package:edu_scale/parent/community/presentation/providers/parent_channel_provider.dart';
import 'package:edu_scale/parent/community/presentation/widgets/parent_channel_card.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class ParentCommunityPage extends StatefulWidget {
  const ParentCommunityPage({super.key});

  @override
  State<ParentCommunityPage> createState() => _ParentCommunityPageState();
}

class _ParentCommunityPageState extends State<ParentCommunityPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ParentChannelsProvider>().getChannels();
    });
  }
  ...
  Widget build(BuildContext context) {
    final provider = context.watch<ParentChannelsProvider>();
            ...
            builder: (context) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ParentChannelCard(
                    channelName: _channelName(channel),
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => ParentChannelPage(channel: channel),
                        ),
                      );
                    },
                  );
  ...
  String _channelName(ParentChannelModel channel) {

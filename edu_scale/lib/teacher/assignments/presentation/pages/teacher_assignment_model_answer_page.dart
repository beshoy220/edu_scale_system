...
class TeacherAssignmentModelAnswerPage extends StatefulWidget {
  final int assignmentId;

  const TeacherAssignmentModelAnswerPage({
    super.key,
    required this.assignmentId,
  });

  @override
  State<TeacherAssignmentModelAnswerPage> createState() =>
      _TeacherAssignmentModelAnswerPageState();
}

class _TeacherAssignmentModelAnswerPageState
    extends State<TeacherAssignmentModelAnswerPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<TeacherAssignmentModelAnswerProvider>().getQuestions(
  ...
  void dispose() {
    ...
    context.read<TeacherAssignmentModelAnswerProvider>().clearQuestions();
    super.dispose();
  }

  @override
  Widget build(BuildContext context) {
    final provider = context.watch<TeacherAssignmentModelAnswerProvider>();

...
// class TeacherAssignmentOptionModel {
//   final int id;
//   final TextEditingController controller;
//   TeacherAssignmentOptionModel({String text = ''})
//     : id = _nextId(),
...
//   final List<TeacherAssignmentOptionModel> options;
//   int correctIndex; // -1 = none selected

//   TeacherAssignmentQuestionModel()
//     : id = _nextId(),
//       titleController = TextEditingController(),
//       options = [
//         TeacherAssignmentOptionModel(),
//         TeacherAssignmentOptionModel(),
...
//   final TeacherAssignmentGradeClassModel selectedGradeClass;
//   final DateTime dueDate;

//   const TeacherAddAssignmentPage({
//     super.key,
...
//   @override
//   State<TeacherAddAssignmentPage> createState() =>
...
//   final List<TeacherAssignmentQuestionModel> _questions = [
//     TeacherAssignmentQuestionModel(),
//   ];
//   int _currentIndex = 0;

//   TeacherAssignmentQuestionModel get _current => _questions[_currentIndex];
...
//     }
//     setState(() {
//       _questions.add(TeacherAssignmentQuestionModel());
...
//       return;
//     }
//     setState(() => _current.options.add(TeacherAssignmentOptionModel()));
//   }
...
//   //   buffer.writeln('===== ASSIGNMENT QUESTIONS (${_questions.length}) =====');
...
//   //       builder: (BuildContext context) => TeacherAssignmentsPage(),
//   //     ),
//   //   );
//   // }
...
//     debugPrint("===== ASSIGNMENT (${_questions.length} Questions) =====");
...
//     // 2. Build the assignment data object
...
//           .from('assignments')
//           .insert(assignmentData.toJson())
//           .select('id')
//           .single();
//       final int assignmentId = assignmentResponse['id'];

//       // Insert questions
//       final questionJsons = assignmentData.questions
//           .map((q) => q.toJson(assignmentId, assignmentData.schoolId))
//           .toList();
//       await supabase.from('assignment_questions').insert(questionJsons);

//       // Show success message
//       _showSnack('Assignment saved successfully!', AppStyle.colors.green);
...
//       );
//     } catch (e) {
//       _showSnack('Error saving assignment: $e', AppStyle.colors.red);
//     }
//   }
...
//   /// Converts the entire assignment + questions into JSON for Supabase.
...
//     // Questions are inserted separately after the assignment is created.
//     // We don't include them here – they go into the assignment_questions table.
//   };
// }
...
//   /// Maps to the six option columns in the assignment_questions table.
//   Map<String, dynamic> toJson(int assignmentId, int schoolId) {
...
// // Future<void> _insertAssignment(AssignmentData data) async {
// //   final supabase = Supabase.instance.client;
...
// //     return q.toJson(assignmentId, data.schoolId);
// //   }).toList();

// //   await supabase.from('assignment_questions').insert(questionJsons);

// //   // 3. (Optional) Update the assignment's number_of_questions if you want.
// //   // It's already set in the assignment row, but you can also set it during insert.
// // }

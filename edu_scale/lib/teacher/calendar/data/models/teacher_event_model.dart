class TeacherEventModel {
  ...
  factory TeacherEventModel.fromJson(Map<String, dynamic> json) {
    return TeacherEventModel(
      id: json['id'],
  ...
  @override
  String toString() {
    return 'TeacherEventModel(id: $id, schoolId: $schoolId, title: $title, description: $description, dayDate: $dayDate, startTime: $startTime, endTime: $endTime, createdAt: $createdAt, targets: $targets)';
  }
}

...
class TeacherBottomSheetNotifications extends StatefulWidget {
  const TeacherBottomSheetNotifications({super.key});

  @override
  State<TeacherBottomSheetNotifications> createState() =>
      _TeacherBottomSheetNotificationsState();
}

class _TeacherBottomSheetNotificationsState
    extends State<TeacherBottomSheetNotifications> {
  @override
  void initState() {
    super.initState();
    ...
    Future.microtask(() {
      if (!mounted) return;
      context.read<TeacherNotificationProvider>().getLast50Notifications();
    });
  }

  @override
  Widget build(BuildContext context) {
    final provider = context.watch<TeacherNotificationProvider>();
    return SizedBox(
      height: 500,
      child: Column(
        children: [

class TeacherQuizQuestionModel {
  ...
  const TeacherQuizQuestionModel({
    required this.questionText,
    required this.options,
    required this.modelAnswer,
  });

  factory TeacherQuizQuestionModel.fromMap(Map<String, dynamic> json) {
    ...
    return TeacherQuizQuestionModel(
  ...
  TeacherQuizQuestionModel copyWith({
    String? questionText,
    List<String>? options,
    String? modelAnswer,
  }) {

...
class StudentPastAssignmentsDisplay extends StatefulWidget {
  const StudentPastAssignmentsDisplay({super.key});

  @override
  State<StudentPastAssignmentsDisplay> createState() =>
      _StudentPastAssignmentsDisplayState();
}

class _StudentPastAssignmentsDisplayState
    extends State<StudentPastAssignmentsDisplay> {
  @override
  void initState() {
    super.initState();

    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<StudentAssignmentsProvider>().getPastAssignments();
    });
  }
    ...
    return Builder(
      builder: (context) {
        ...
        if (provider.assignments.isEmpty) {
          return const Center(child: Text('No past assignments'));
        }

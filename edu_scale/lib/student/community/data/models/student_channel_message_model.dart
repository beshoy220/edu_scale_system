class StudentChannelMessageModel {
  final int id;
  final int channelId;
  ...
  const StudentChannelMessageModel({
    required this.id,
  ...
  factory StudentChannelMessageModel.fromJson(Map<String, dynamic> json) {
    return StudentChannelMessageModel(
      id: json['id'] as int,
  ...
  StudentChannelMessageModel copyWith({
    int? id,
    int? channelId,
  ...
  @override
  String toString() {
    return 'StudentChannelMessageModel(id: $id, channelId: $channelId, sender: $sender, messageText: $messageText)';
  }
}

...
class StudentChannelPage extends StatefulWidget {
  const StudentChannelPage({super.key, required this.channel});

  final StudentChannelModel channel;

  @override
  State<StudentChannelPage> createState() => _StudentChannelPageState();
}

class _StudentChannelPageState extends State<StudentChannelPage> {
  @override
  void initState() {
    super.initState();

    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<StudentChannelMessagesProvider>().loadMessages(
  ...
  Widget build(BuildContext context) {
    final provider = context.watch<StudentChannelMessagesProvider>();
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  SizedBox(width: 12),
                  Expanded(child: Text('Students cannot send messages yet.')),
                ],
              ),
            ),
          ],

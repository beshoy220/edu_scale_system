...
class StudentCalendarDaysSelector extends StatefulWidget {
  final Function(DateTime selectedDate) onDateSelected;
  final Function(DateTime focusedDay) onPageChanged;
  final DateTime? initialDate;
  final List<DateTime> eventDates;

  const StudentCalendarDaysSelector({
    super.key,
  ...
  @override
  State<StudentCalendarDaysSelector> createState() =>
      _StudentCalendarDaysSelectorState();
}

class _StudentCalendarDaysSelectorState
    extends State<StudentCalendarDaysSelector> {

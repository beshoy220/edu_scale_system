import 'package:edu_scale/student/calendar/data/data_sources/get_student_events_remote_data_source.dart';
...
class StudentEventsProvider extends ChangeNotifier {
  List<StudentEventModel> twoMonthEvents = [];
  ...
  List<StudentEventModel> listOfEventsOfDaySelected = [];
  ...
  Future<void> getEventsByDate(DateTime date) async {
    ...
    try {
      final result = await GetStudentEventsRemoteDataSource().getByDateRange(
        date,
      );

class StudentEventModel {
  ...
  @override
  String toString() {
    return 'StudentEventModel(id: $id, schoolId: $schoolId, title: $title, description: $description, dayDate: $dayDate, startTime: $startTime, endTime: $endTime, createdAt: $createdAt, targets: $targets)';
  }
}

...
class StudentPastQuizzesDisplay extends StatefulWidget {
  const StudentPastQuizzesDisplay({super.key});

  @override
  State<StudentPastQuizzesDisplay> createState() =>
      _StudentPastQuizzesDisplayState();
}

class _StudentPastQuizzesDisplayState extends State<StudentPastQuizzesDisplay> {
  @override
  void initState() {
    super.initState();

    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<StudentQuizzesProvider>().getPastQuizzes();
    });
  }
    ...
    return Builder(
      builder: (context) {
        ...
        if (provider.quizzes.isEmpty) {
          return const Center(child: Text('No past quizzes'));
        }
...
class _StudentQuizCardState extends State<StudentQuizCard> {
  ...
  Widget build(BuildContext context) {
    ...
    if (isDone) {
      ...
      badgeText = 'MISSED';
      badgeColor = AppStyle.colors.red;
    }

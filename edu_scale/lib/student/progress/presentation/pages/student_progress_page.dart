...
import 'package:edu_scale/student/progress/presentation/widgets/student_progress_info_bottom_sheet.dart';
...
class _StudentProgressPageState extends State<StudentProgressPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<StudentProgressProvider>().getProgress();
    });
  }
                    ...
                    InkWell(
                      onTap: () {
                        showModalBottomSheet(
                          ...
                          builder: (context) {
                            return StudentProgressInfoBottomSheet();
                          },
                        );
                      },
                      child: Container(

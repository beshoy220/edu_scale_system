...
class StudentProgressInfoBottomSheet extends StatefulWidget {
  const StudentProgressInfoBottomSheet({super.key});

  @override
  State<StudentProgressInfoBottomSheet> createState() =>
      _StudentProgressInfoBottomSheetState();
}

class _StudentProgressInfoBottomSheetState
    extends State<StudentProgressInfoBottomSheet> {
  @override
  void initState() {
    super.initState();

    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<StudentAvailableBadgesProvider>().getBadges();
    });
  }

  @override
  Widget build(BuildContext context) {
    final badgesProvider = context.watch<StudentAvailableBadgesProvider>();
